...
const RoomHeader: React.FC<RoomHeaderProps> = ({
  ...
  return (
    <div className="bg-slate-100/70 shadow-md p-1 flex items-center justify-between dark:bg-gray-800">
      <div className="flex items-center space-x-2">
        <h4 className="text-1xl font-semibold">{roomName}</h4>
        <button onClick={handleCopyClick} className="py-2 px-2 rounded">
      ...
      <span className="text-1xl text-gray-500 dark:text-gray-300">
        Welcome, {userName}
      </span>
